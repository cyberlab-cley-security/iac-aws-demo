...
This repository provides a lab to show deployment of an EKS cluster and its associated infrastructure  (VPC, SG, EC2, S3, etc.) in an automated way with GitHub Action.
...
- Number of worker nodes in eks_cluster : **default = 1** (choice between 1 to 5)

- Worker nodes type in eks_cluster : **default = t3.medium** 

- Public ssh key to connect to ec2-bastion/MonGoDB host : **Your SSH PUBLIC KEY**
